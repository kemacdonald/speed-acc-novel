...
ms_time %>% 
  ...
  plot_timecourse(facet_type = "trial_num_learn_block~trial_type") +
  geom_vline(xintercept = gaze_onset$m_gaze_onset, lty = "dashed")
```

### Plot as a function of order
...
### Plot as a function of trial number in the learning block
...
### Split and plot timecourse by block number (whether you got gaze or straight ahead first).
