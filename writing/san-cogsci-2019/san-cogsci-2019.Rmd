...
How should we characterize the effects of gaze in our task? Children selectively gathered social information when they were uncertain about the meaning of a new word, focusing attention on a single object. This behavior generalized to trials without a gaze cue, showing how the effect of gaze can accumulate over time. Finally, seeking social gaze increased the rate of word learning for adults. This finding dovetails with work showing that the presence of social information changes information processing [@yoon2008communication]. 
